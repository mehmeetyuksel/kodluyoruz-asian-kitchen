...
filterButtons.addEventListener("click", (e) => {
  ...
  else if(e.target.id === "filter-buttons") {
    console.log("Boşluğa tıklanınca itemlerin kaybolma sorunu giderildi...")
  }
  else {
  newMenu = menu.filter((element) => element.category === e.target.id)
  showItems(newMenu)
  }
})
...
menuItems.innerHTML =""
menu.map(element => menuItems.innerHTML += `
  <div class="items"> 
